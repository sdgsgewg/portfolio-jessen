...
import { SiTypescript, SiHtml5, SiCss } from "react-icons/si";
...
export default function TechIcons() {
  ...
  return (
    <>
      ...
      <Image
        src={IMAGES.SKILL.TECHNICAL_SKILL.C_SHARP}
        width={iconSize}
        height={iconSize}
        alt="C#"
      ...
      <Image
        src={IMAGES.SKILL.TECHNICAL_SKILL.TAILWIND_CSS}
        width={iconSize}
        height={iconSize}
        alt="Tailwind CSS"
        className={`${baseClasses}`}
      ...
      <Image
        src={IMAGES.SKILL.TECHNICAL_SKILL.FIGMA}
        width={iconSize}
        height={iconSize}
        alt="Figma"
        className={`${baseClasses}`}
